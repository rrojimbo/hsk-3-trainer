...
# hsk-3-trainer
=======
# HSK 3 — онлайн-тренажёр (React)

Веб‑приложение для подготовки к HSK 3 **на русском языке**. Работает полностью в браузере, хранит прогресс в `localStorage`, поддерживает деплой на Vercel с чистыми URL и автоматическим HTTPS.
